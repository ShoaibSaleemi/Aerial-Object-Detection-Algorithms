...
CONFIG = {
    "model": "runs/fasterrcnn/train/fasterrcnn_epoch_50.pt",
    "images": "dataset/validation/images",
    "labels": "dataset/validation/labels",
    "iou_thresh": 0.5,
    "conf_thresh": 0.5,
    "save_plot": "runs/fasterrcnn/train/confusion_matrix_val.png",
    "save_metrics_plot": "runs/fasterrcnn/train/metrics_table_val.png",
